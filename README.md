...
- **Backend**: Node.js con Express para el servidor
...
```
├── client1/          # Primera instancia del cliente
│   ├── index.html    # Interfaz
│   ├── styles.css    # Estilos
│   └── app.js        # Lógica de la app
├── client2/          # Segunda instancia (mismo código)
└── server/           # Backend
...
- **Puerto ocupado**: Cambia el PORT en `server.js` y también en `app.js` de los clientes
